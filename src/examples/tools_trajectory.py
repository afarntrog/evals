...
def tools_trajectory_example():
    ...
    test_case2 = Case[str, str](
        name="calculator-2", input="What is 2x2?", expected_output="4", metadata={"category": "math"}
    )

    ### Step 2: Create evaluator ###
    trajectory_evaluator = TrajectoryEvaluator(
        rubric="The trajectory should represent a reasonable use of tools based on the input.", include_inputs=True
    )
