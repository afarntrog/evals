...
class TestEvaluator:
    ...
    def test_simple_evaluator_matching_output(self):
        ...
        evaluator = SimpleEvaluator()
        evaluation_data = EvaluationData(input="test", actual_output="match", expected_output="match")
    ...
    def test_evaluator_with_none_values(self):
        ...
        evaluator = SimpleEvaluator()
        evaluation_data = EvaluationData(input="test", actual_output=None, expected_output="expected")
    ...
    def test_evaluator_with_empty_strings(self):
        ...
        evaluator = SimpleEvaluator()
        evaluation_data = EvaluationData(input="test", actual_output="", expected_output="")
